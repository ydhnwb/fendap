...
class FragmentRuang : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mList.add(ChatModel("Algi", "iyo benar min ambo pulo nengok tadi,, solusi yang tepatnyo lemak kito aksi bersih pantai bae minggu besok, kito ajak galo kawan-kawan tu, cak mano? ", 1))
